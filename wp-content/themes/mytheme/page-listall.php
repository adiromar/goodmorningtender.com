...
<section class="hero-section-1 main-pg-section">
	<div class="containersss lg-breadcrumb">
		<div class="card p-4">
...
<div class="container mt-3 mb-3">
		<div class="row">
			...
			<div class="col-md-3 col-sm-12">
				<button class="btn btn-info" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample" style="float: right;"><i class="fa fa-search"></i> Advanced Search</button>
			</div>
		</div>
		...
		<div class="row">
			  <div class="cards card-bodys">
			    ...
			    <form action="<?php echo site_url() ?>/wp-admin/admin-ajax.php" method="POST" id="filter" style="background: #efeded;padding: 20px 15px;border: 1px solid lightgrey;">
...
foreach ( $terms as $term ) :
	echo '<div class="col-md-6 col-md-12">';
...
<!-- newspaper category modal ends  -->
	...
	<div class="container cards" id="scroll_id">
		<div class="row">
			...
			<ul class="nav nav-tabs" id="myTab2" role="tablist" style="float: right;">
				  <li class="nav-item">
