	...
	<div class="row mt-4 mb-4">
		<div class="col-md-12 col-sm-12">
			...
			<div class="mt-3 mb-4">
				...
				<table class="table table-hover table-striped table-responsive" style="line-height: 0.7rem;">
					<tr>
				...
				<?php }if($ind_names){ ?>
					...
					<tr>
						<th width="5%"></th>
						<th width="40%">Need Support on Proposal Writing?</th>
						<td width="5%">:</td>
						<td width="50%"><a href="#" data-toggle="modal" data-target="#support_modal" class="quote-btn-supprt write-supp">Click Here</a></td>
					</tr>
				</table>
			</div>
...
<!-- <div class="col-md-12 col-sm-12 pt-4 pb-2">
	<div class="row">
		<div class="col-md-6 col-sm-12">
			<a href="#" data-toggle="modal" data-target="#support_modal" class="quote-btn-supprt write-supp">Need Support on Proposal Writing?</a>
		</div>
		<div class="col-md-6 col-sm-12 pull-right req-quo" style="text-align: right;">
