...
<table class="table table-bordered table-striped table-hover table-responsive" id="list_view_tbl">
	<thead>
	...
	<tbody class="resp" style="font-size: 13px !important;">
		<?php
		$date = date("Y-m-d");
		$args = array (
		...
		<tr class="tbody_tr">
			...
			<td><?= mb_strimwidth($cat_names, 0, 25, '...'); ?></td>
			<td><?= mb_strimwidth($paper_names, 0, 25, '...'); ?></td>
			<td><?= mb_strimwidth($ind_names, 0, 25, '...'); ?></td>
			<td width="">
			<?php
			if( $diff >= 0){
