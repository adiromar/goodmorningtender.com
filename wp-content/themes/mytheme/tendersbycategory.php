		...
		<div class="row">
				...
				foreach ($category as $val) {
					echo '<div class="col-md-2 cat-lists">';
						echo '<div class="row">';
							echo '<div class="col-md-12 ctg-12">';
						if ( z_taxonomy_image_url($val->term_id) ){
							?>
							<a href="<?php echo esc_url( get_term_link( $term ) ) ?>"><img src="<?= z_taxonomy_image_url($val->term_id); ?>" width="180" height="120" class="thumb-pad"></a>
						...
						<?php } 
							echo '</div>';
							echo '<div class="col-md-12 cat-list ctg-data-12">';
			...
			<div class="row">
				...
				foreach ($tax as $val) {
					...
					$terms = get_terms( $val, $args = array(
					  'hide_empty' => false,
					  // 'parent' => 0 // do not hide empty terms
					));
